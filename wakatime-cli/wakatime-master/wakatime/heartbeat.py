...
class Heartbeat(object):
    ...
    def __init__(self, data, args, configs, _clone=None):
        ...
        if not _clone:
            ...
            if self.type == 'file':
                ...
                if not self._file_exists():
                    self.entity = format_file_path(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'General.sql'))
                    self._format_local_file()
        ...
        # if data.get('entity', '/GENERAL.SQL').upper().endswith('/GENERAL.SQL'):
        #   data['entity'] = 'General.sql'
